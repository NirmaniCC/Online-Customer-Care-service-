							                    ...
							                    <table class="table center-aligned-table">
							                      ...
							                      <%
							                       try {
							                           ...
							                           String sql = "SELECT f.feedback_id, f.message, u.fullName, ft.feedback_type, f.created_at FROM feedback f JOIN users u ON f.users_user_id = u.user_id JOIN feedback_type ft ON f.feedback_type_feedback_type_id = ft.feedback_type_id";
							                      ...
							                      <tbody>
							                        <tr class="">
							                          ...
							                          <td><a href="manageFeedback.jsp?id=<%=mob%>" class="btn btn-primary btn-sm">Manage</a></td>
							                          <td><a href="deleteFeedback.jsp?id=<%=mob%>" class="btn btn-danger btn-sm">Remove</a></td>
							                        </tr>							                        
							                      </tbody>
							                      <%
						                                   }
