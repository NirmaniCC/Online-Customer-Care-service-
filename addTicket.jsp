            ...
            <div class="row mt-2" id="card-prof">
                ...
                <div class="col-md-9">
                    <div class="card form" style="padding-left:10px; padding-right:10px" >
                        ...
                        <br>
                        <form method="post" action="/CustomerCare/addTicketServelet?userId=${userObj.userId}">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Subject</label>
                                        <input type="text" class="form-control" name="name" aria-describedby="emailHelp" placeholder="Enter Subject">
                                    </div>
                                    <div class="form-group">
