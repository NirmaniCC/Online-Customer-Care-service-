							                    ...
							                    <table class="table center-aligned-table">
							                      ...
							                      <tbody>
							                        <tr class="">
							                          ...
							                          <td><a href="manageuserFeedback.jsp?id=<%=mob%>" class="btn btn-success btn-sm">Feedbacks</a>
							                          <a href="manageUserTickt.jsp?id=<%=mob%>" class="btn btn-warning btn-sm">TIckets</a></td>
							                          <td><a href="manageUser.jsp?id=<%=mob%>" class="btn btn-primary btn-sm">Manage</a>
							                          <a href="deleteAccounts.jsp?id=<%=mob%>" class="btn btn-danger btn-sm">Remove</a></td>
							                        </tr>							                        
							                      </tbody>
							                      <%
						                                   }
