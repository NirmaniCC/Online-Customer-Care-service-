    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            ...
            <ul class="list-unstyled">
                ...
                <li class="active"> <a href="tickets.jsp">Tickets</a></li>
							                    ...
							                    <table class="table center-aligned-table">
							                      ...
							                      <%
							                       try {
							                           ...
							                           String sql = "SELECT t.ticket_id, t.subject, t.description, u.fullName, c.category_name, t.updated_at FROM tickets t JOIN users u ON t.users_user_id = u.user_id JOIN categories c ON t.categories_category_id = c.category_id";
							                      ...
							                      <tbody>
							                        <tr class="">
							                          ...
							                          <td><a href="manageTicket.jsp?id=<%=mob%>" class="btn btn-primary btn-sm">Manage</a></td>
							                          <td><a href="deleteTicket.jsp?id=<%=mob%>" class="btn btn-danger btn-sm">Remove</a></td>
							                        </tr>							                        
							                      </tbody>
							                      <%
						                                   }
