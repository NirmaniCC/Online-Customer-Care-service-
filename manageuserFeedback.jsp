							                    ...
							                    <table class="table center-aligned-table">
							                      ...
							                      <%
							                       try {
							                    	   ...
							                    	   String sql = "SELECT f.feedback_id, f.message, f.created_at, ft.feedback_type FROM feedback f JOIN feedback_type ft ON f.feedback_type_feedback_type_id = ft.feedback_type_id WHERE f.users_user_id = ?";
