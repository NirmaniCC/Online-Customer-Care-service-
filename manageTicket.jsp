				                    ...
				                    <div class="card form" style="padding: 20px">
				                        ...
				                        <%
			                              try {         
											...
											String s1 = "SELECT t.ticket_id, t.subject, t.description, t.updated_at, u.fullName, u.email, u.mobile, c.category_name FROM tickets t JOIN users u ON t.users_user_id = u.user_id JOIN categories c ON t.categories_category_id = c.category_id WHERE ticket_id = ?";
				                            ...
				                            <div class="row">
				                                <div class="col-md-6">
				                                    ...
				                                    <div class="form-group">
				                                        ...
				                                        <input type="text" class="form-control" name="subject" value="<%= rs1.getString(2)%>" readonly>
				                                    </div>
				                                    <div class="form-group">
				                                        <label for="name">Description</label>
				                                        <input type="text" class="form-control" name="description" value="<%= rs1.getString(3)%>" readonly>
				                                    </div>
				                                    <div class="form-group">
				                                ...
				                                <div class="col-md-6">
				                                    ...
				                                    <div class="form-group">
				                                        ...
				                                        <input type="text" class="form-control" name="category" value="<%= rs1.getString(8)%>" readonly>
				                                    </div>
				                                </div>
				                            </div> 
